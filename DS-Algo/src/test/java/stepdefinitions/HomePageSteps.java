...
public void the_user_should_land_in_data_structure_introduction_page_with_and_links(String string1, String string2) {
	...
	Assert.assertEquals(register, string1);
...
public void the_user_should_able_to_see_options_arrays_in_drop_down_section(Integer int1, DataTable dataTable) {
